document.addEventListener('DOMContentLoaded', () => {
    const cardsArray = ['./img/maca.webp', './img/banana.png', './img/uva.png', './img/morango.png', './img/cereja.png', './img/abacaxi.png', './img/melancia.png', './img/limao.png'];
    ...
    let timer;
    let timeRemaining = 120; // 3 minutos em segundos
    let matches = 0;
